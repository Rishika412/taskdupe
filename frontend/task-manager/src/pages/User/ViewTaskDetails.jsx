      ...
      <div className="mt-5">
        {task && (
          <div className="grid grid-cols-1 md:grid-cols-4 mt-4 gap-4">
            <div className="form-card col-span-3 p-4 bg-white rounded shadow">
...
const InfoBox = ({ label, value }) => {
  return (
    <div className="mb-4">
      ...
      <p className="text-[12px] md:text-[13px] font-medium text-gray-700 mt-0">
        {value}
      </p>
    </div>
  );
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div
      className="flex justify-between items-center bg-gray-50 border border-gray-100 px-3 py-2 mb-2 rounded cursor-pointer"
      onClick={onClick}
    >
...
export { InfoBox, TodoChecklist, Attachment };
